...
public class Constant {
    //MODIFICATION PART
    public static final String MAINBASEUrl = "https://bayiealhalib.jaffare.com/"; //Admin panel url
    ...
    public static final String WebsiteUrl = "https://bayiealhalib.jaffare.com/";
    public static final int GRIDCOLUMN = 3; //Category View Number Of Grid Per Line
    public static final int LOAD_ITEM_LIMIT = 6; //Load items limit in listing ,Maximum load item once
